...
class XQPopMenu: UIView {
    ...
    func initViews() {
        ...
        tableView.register(SwiftPopMenuCell.classForCoder(), forCellReuseIdentifier: XQPopMenu.cellID)
...
class SwiftPopMenuCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        line = UIView()
        line.backgroundColor = UIColor(red: 222/255.0, green: 222/255.0, blue: 222/255.0, alpha: 1)
    ...
    override func layoutSubviews() {
        ...
        self.iconImage.frame = CGRect(x: 15, y: (self.bounds.size.height - 20)/2 + 2.5, width: 15, height: 15)
...
extension XQPopMenu : UITableViewDataSource{
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if popData.count>indexPath.row {
            let cell = tableView.dequeueReusableCell(withIdentifier: XQPopMenu.cellID) as! SwiftPopMenuCell
...
extension XQPopMenu : UITableViewDelegate{
