//
//  LOLHeroTotalViewController.swift
//  DouYuTV
//
...
class LOLHeroTotalViewController: BaseClassifyViewController {
    private lazy var  lolHeroVM : LOLViewModel = LOLViewModel()
...
extension LOLHeroTotalViewController{
    override func loadData() {
        baseVM = lolHeroVM
        lolHeroVM.requestHeroData {[weak self] in
...
extension LOLHeroTotalViewController : UICollectionViewDelegateFlowLayout{
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.kingModel = lolHeroVM.anchorClassifyModel[indexPath.section].classify[indexPath.item]
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        headerView.heroAnchor = lolHeroVM.anchorClassifyModel[indexPath.section]
        return headerView
    }
}
extension LOLHeroTotalViewController{
