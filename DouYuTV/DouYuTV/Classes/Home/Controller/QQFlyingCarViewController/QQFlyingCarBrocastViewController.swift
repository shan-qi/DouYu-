//
//  QQFlyingCarBrocastViewController.swift
//  DouYuTV
//
...
class QQFlyingCarBrocastViewController: UIViewController {

    private lazy var QQFlyingCarDownTitileView : PageSubTitleView = {
    ...
    private lazy var pageContentView : PageContentView = {
        ...
        //2.确定子控制器
        var childVcs = [QQFlyingCarSubViewController]()
        for type in homeTypes {
            let anchorVC = QQFlyingCarSubViewController()
            anchorVC.home = type
    ...
    private func loadTypesData() ->[HomeStyle] {
        let path = Bundle.main.path(forResource: "QQFlyingCar", ofType: "plist")
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.addSubview(QQFlyingCarDownTitileView)
        view.addSubview(pageContentView)
        view.insertSubview(pageContentView, belowSubview: QQFlyingCarDownTitileView)
    }
}
//遵守pageTitleViewDelegate协议
extension QQFlyingCarBrocastViewController : pageSubTitleViewDelegate{
