//
//  SurvivalBrocastViewController.swift
//  DouYuTV
//
...
class SurvivalBrocastViewController: UIViewController {
    
    private lazy var survivalDownTitileView : PageSubTitleView = {
    ...
    private lazy var pageContentView : PageContentView = {
        ...
        //2.确定子控制器
        var childVcs = [SurviveSubViewController]()
        for type in homeTypes {
            let anchorVC = SurviveSubViewController()
            anchorVC.home = type
    ...
    private func loadTypesData() ->[HomeStyle] {
        let path = Bundle.main.path(forResource: "Survive", ofType: "plist")
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.addSubview(survivalDownTitileView)
        view.addSubview(pageContentView)
        view.insertSubview(pageContentView, belowSubview: survivalDownTitileView)
    }
}
//遵守pageTitleViewDelegate协议
extension SurvivalBrocastViewController : pageSubTitleViewDelegate{
