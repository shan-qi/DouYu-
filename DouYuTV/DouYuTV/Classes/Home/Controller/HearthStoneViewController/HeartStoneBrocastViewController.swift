//
//  HeartStoneBrocastViewController.swift
//  DouYuTV
//
...
class HeartStoneBrocastViewController: UIViewController {

    private lazy var HeartStoneDownTitileView : PageSubTitleView = {
    ...
    private lazy var pageContentView : PageContentView = {
        ...
        //2.确定子控制器
        var childVcs = [HeartStoneSubViewController]()
        for type in homeTypes {
            let anchorVC = HeartStoneSubViewController()
            anchorVC.home = type
    ...
    private func loadTypesData() ->[HomeStyle] {
        let path = Bundle.main.path(forResource: "HeartStone", ofType: "plist")
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.addSubview(HeartStoneDownTitileView)
        view.addSubview(pageContentView)
        view.insertSubview(pageContentView, belowSubview: HeartStoneDownTitileView)
    }
}
//遵守pageTitleViewDelegate协议
extension HeartStoneBrocastViewController : pageSubTitleViewDelegate{
