//
//  WholeArmyBrocastViewController.swift
//  DouYuTV
//
...
class WholeArmyBrocastViewController: UIViewController {

    private lazy var WholeArmyDownTitileView : PageSubTitleView = {
    ...
    private lazy var pageContentView : PageContentView = {
        ...
        //2.确定子控制器
        var childVcs = [WholeArmySubViewController]()
        for type in homeTypes {
            let anchorVC = WholeArmySubViewController()
            anchorVC.home = type
    ...
    private func loadTypesData() ->[HomeStyle] {
        let path = Bundle.main.path(forResource: "WholeArmy", ofType: "plist")
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.addSubview(WholeArmyDownTitileView)
        view.addSubview(pageContentView)
        view.insertSubview(pageContentView, belowSubview: WholeArmyDownTitileView)
    }
}
//遵守pageTitleViewDelegate协议
extension WholeArmyBrocastViewController : pageSubTitleViewDelegate{
