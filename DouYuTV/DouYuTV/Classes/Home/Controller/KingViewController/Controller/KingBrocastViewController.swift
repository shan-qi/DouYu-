//
//  KingBrocastViewController.swift
//  DouYuTV
//
...
class KingBrocastViewController: UIViewController {
    private lazy var kingDownTitileView : PageSubTitleView = {
    ...
    private lazy var pageContentView : PageContentView = {
        ...
        //2.确定子控制器
        var childVcs = [KingSubViewController]()
        for type in homeTypes {
            let anchorVC = KingSubViewController()
            anchorVC.home = type
    ...
    private func loadTypesData() ->[HomeStyle] {
        let path = Bundle.main.path(forResource: "King", ofType: "plist")
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.addSubview(kingDownTitileView)
        view.addSubview(pageContentView)
        view.insertSubview(pageContentView, belowSubview: kingDownTitileView)
    }
}
//遵守pageTitleViewDelegate协议
extension KingBrocastViewController : pageSubTitleViewDelegate{
